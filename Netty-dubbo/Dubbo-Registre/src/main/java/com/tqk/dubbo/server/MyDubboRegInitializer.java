 ...
 * @author tianqikai
 */
public class MyDubboRegInitializer extends ChannelInitializer<SocketChannel> {
    //创建业务线程池
    //这里我们就创建2个子线程
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast(new IdleStateHandler(30,30,80, TimeUnit.SECONDS));
        pipeline.addLast(new MyMessageDecoder());//解码器
        pipeline.addLast(new MyMessageEncoder());//编码器
        pipeline.addLast(executorGroup,new MyDubboRegHandler());
    }
}
